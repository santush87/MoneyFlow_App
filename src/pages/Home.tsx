        ...
        <div className="flex flex-col items-center">
            <div className="lg:flex max-w-3xl min-w-96  mt-4 py-4 px-6 gap-5">
                <div className="flex lg:flex-col items-center rounded-3xl justify-evenly py-4 px-6 bg-slate-800">
                    ...
                    <div>
                        <p className="text-md font-semibold leading-6 text-indigo-300 text-center">Здравей,</p>
                        <h3 className="text-base font-semibold leading-7 tracking-tight text-indigo-500 ">{profile.firstName} {profile.lastName}</h3>
                    </div>
                </div>
